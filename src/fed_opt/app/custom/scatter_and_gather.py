    ...
    def control_flow(self, abort_signal: Signal, fl_ctx: FLContext) -> None:
        try:
            ...
            while self._current_round < self._start_round + self._num_rounds:
                ...
                # We print the optimizer's learning rate to verify that the scheduler is working as expected (and FYI).
                for param_group in self.shareable_gen.optimizer.param_groups:
                    self.log_info(fl_ctx, f"Server Learning Rate: {param_group['lr']}")
